(function() {
    ...
    (function($, window) {
        ...
        chardinJs = (function() {
            ...
            chardinJs.prototype._add_overlay_layer = function() {
                ...
                if (this.$el.prop('tagName') === "BODY") {
                    ...
                    element_position = this._get_offset(this.$el.get());
                    if (element_position) {
                        styleText += "width: " + element_position.width + "px; height:" + element_position.height + "px; top:" + element_position.top + "px;left: " + element_position.left + "px;";
                        overlay_layer.setAttribute("style", styleText);
                    }
                }
                this.$el.get().appendChild(overlay_layer);
            ...
            chardinJs.prototype._show_element = function(element) {
                ...
                this.$el.get().appendChild(helper_layer);
        ...
        chardinJs.init = function(element){
        ...
        return $.extend({
            ...
            chardinJs: function() {
                ...
                if (!data) {
                    $this.data('chardinJs', (data = new chardinJs(arguments[1], option)));
                }
